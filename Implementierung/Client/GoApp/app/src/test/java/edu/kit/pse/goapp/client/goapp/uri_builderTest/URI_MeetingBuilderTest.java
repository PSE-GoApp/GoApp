 ...
 */
public class URI_MeetingBuilderTest {
    @Test
    public void builderTest() {
        URI_MeetingBuilder builder = new URI_MeetingBuilder();
        URI uri = builder.getURI();
        URI testUri = null;
        try {
            testUri = new URI("https://i43pc164.ipd.kit.edu/PSESoSe16GoGruppe2/GoAppServer/Meeting");
    ...
    public void addParameterTest() {
        ...
        URI testUri= null;
        try {
            testUri = new URI("https://i43pc164.ipd.kit.edu/PSESoSe16GoGruppe2/GoAppServer/Meeting?testKey=testValue");
        } catch (java.net.URISyntaxException e){
            //cant happen
        }
        assertEquals(testUri,uri);
